...
INSERT INTO `ofProperty` VALUES ('adminConsole.port','9090'),('adminConsole.securePort','9091'),('connectionProvider.className','org.jivesoftware.database.DefaultConnectionProvider'),('database.defaultProvider.connectionTimeout','1.0'),('database.defaultProvider.driver','com.mysql.jdbc.Driver'),('database.defaultProvider.maxConnections','50'),('database.defaultProvider.minConnections','5'),('database.defaultProvider.password','3f353f3835b82aa0b02617717b0fe9f29a1f24b853db509cb5146b444741c55f'),('database.defaultProvider.serverURL','jdbc:mysql://localhost:3306/openfire?useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8'),('database.defaultProvider.testAfterUse','false'),('database.defaultProvider.testBeforeUse','false'),('database.defaultProvider.testSQL','select 1'),('database.defaultProvider.username','2f1262c50d237f500865c2c15ff849f815e8e9eb2eb16eba'),('locale','en'),('passwordKey','l982J5mBLfvAGJE'),('provider.admin.className','org.jivesoftware.openfire.admin.DefaultAdminProvider'),('provider.auth.className','org.jivesoftware.openfire.auth.DefaultAuthProvider'),('provider.group.className','org.jivesoftware.openfire.group.DefaultGroupProvider'),('provider.lockout.className','org.jivesoftware.openfire.lockout.DefaultLockOutProvider'),('provider.securityAudit.className','org.jivesoftware.openfire.security.DefaultSecurityAuditProvider'),('provider.user.className','org.jivesoftware.openfire.user.DefaultUserProvider'),('provider.vcard.className','org.jivesoftware.openfire.vcard.DefaultVCardProvider'),('sasl.scram-sha-1.iteration-count','4096'),('setup','true'),('stream.management.active','true'),('stream.management.requestFrequency','5'),('update.lastCheck','1470396963538'),('xmpp.auth.anonymous','true'),('xmpp.domain','demo.loc'),('xmpp.session.conflict-limit','0'),('xmpp.socket.ssl.active','true');
...
INSERT INTO `ofPubsubAffiliation` VALUES ('pubsub','','demo.loc','owner');
...
INSERT INTO `ofPubsubNode` VALUES ('pubsub','',0,'001470396928107','001470396928107',NULL,0,0,0,0,1,1,1,0,0,'publishers',1,0,'open','','','','demo.loc','','English','',NULL,'all',-1);
...
INSERT INTO `ofUser` VALUES ('admin','wEhflYw/waSl6Iysm35BPaDvSkE=','HlR0DJrkgh1MEViUaEctdJnhBJM=','JXgX9IYZZkKStNmuSUT9IrI8zLVZTN3W',4096,NULL,'59712106577f8477552bd7a96c1bb7ed3c9c8601cdbd232135da2c29f7ab1080','Administrator','admin@demo.loc','001470396924431','0');
...
-- Dump completed on 2016-08-05 11:47:50
