...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quote_locationrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('packer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quote.Packer'], null=True, blank=True)),
        ...
        db.send_create_signal(u'quote', ['LocationRelation'])


    def backwards(self, orm):
        # Deleting model 'LocationRelation'
        db.delete_table(u'quote_locationrelation')
