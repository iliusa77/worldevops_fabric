...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuoteInfo.specifications'
        db.add_column(u'quote_quoteinfo', 'specifications',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuoteInfo.port_of_delivery'
        db.add_column(u'quote_quoteinfo', 'port_of_delivery',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuoteInfo.type_of_delivery'
        db.add_column(u'quote_quoteinfo', 'type_of_delivery',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuoteInfo.specifications'
        db.delete_column(u'quote_quoteinfo', 'specifications')

        # Deleting field 'QuoteInfo.port_of_delivery'
        db.delete_column(u'quote_quoteinfo', 'port_of_delivery')

        # Deleting field 'QuoteInfo.type_of_delivery'
        db.delete_column(u'quote_quoteinfo', 'type_of_delivery')
