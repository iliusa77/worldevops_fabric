...
user = 'mautic'  # master user, owner of the application
domain = 'mautic.hunterstone.com.au'
...
if __name__ == '__main__':
    ...
    passwd = genpass()
    command = 'fab --user=worldevops -H {host} create_app_user:{user},passwd={passwd} --set=domain={domain}'.format(
    ...
    command = 'fab -H {host} --user={user} --password={passwd} --set=domain={domain} setup_with_nginx'.format(
