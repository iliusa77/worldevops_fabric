...
user = 'ronn'  # master user, owner of the application
domain = 'localhost'
...
if __name__ == '__main__':
    ...
    passwd = genpass()
    command = 'fab --user=worldevops -H {host} --set=domain={domain},ip={host},http_server=nginx create_app_user:{user},passwd={passwd}'.format(
    ...
    command = 'fab -H {host} --user={user} --password={passwd} --set=domain={domain},ip={host},http_server=nginx setup'.format(
