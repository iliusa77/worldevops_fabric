...
user = 'vapenow'  # master user, owner of the application
domain = 'vapenow-eg.com'
...
if __name__ == '__main__':
    ...
    command = 'fab -H {host} --user={user} --set=domain={domain} --password={passwd} setup_with_nginx'.format(
